...
const translations = {
  en: {
    ...
    aboutText1: 'The Pharmacy Training Management System (PTMS) is a state-of-the-art solution designed to digitize and streamline the mandatory training process for pharmacy students at Al-Hadba\'a University.',
  ...
  ar: {
    ...
    aboutText1: 'نظام إدارة التدريب الصيدلاني (PTMS) هو حل متطور مصمم لرقمنة وتبسيط عملية التدريب الإلزامية لطلاب الصيدلة في جامعة الحدباء.',
